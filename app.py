...
class User(db.Model):
    ...
    rated_papers = db.relationship("Score", back_populates="reviewer")
    papers = db.relationship("Authors", back_populates="author")
...
class Paper(db.Model):
    ...
    authors = db.relationship("Authors", back_populates="paper")
